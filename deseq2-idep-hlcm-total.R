...
ggsave(filename = "E:/paper-files/hlcm_total_pca_small.png", plot = pcaplot, width = 4, height = 3, dpi = 800)
ggsave(filename = "E:/paper-files/hlcm_total_pca_big.png", plot = pcaplot, width = 8, height = 6, dpi = 800)
